...
with open(sys.argv[1]) as f:
    ...
    table.append( ["TOTAL", "---", round(TOTAL_CALS, 2), \
                                   round(TOTAL_C, 2),    \
                                   round(TOTAL_P, 2),    \
                                   round(TOTAL_F, 2)])
    ...
    print("Cals left: " + str(round ((calorie_lim - TOTAL_CALS), 2)) + \
          " Carbs left: " + str (round ((carb_lim - TOTAL_C), 2)) +    \
          " Protein left: " + str (round ((pro_lim - TOTAL_P),2)) +    \
          " Fats left: " + str (round((fat_lim - TOTAL_F),2)) )
